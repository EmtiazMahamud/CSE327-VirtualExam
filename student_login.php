<?php
/**
 * Student login handler with authentication
 * 
 * Processes student login credentials and manages session initiation
...
<body class="login">
    <div class="login__card">
        ...
        <a class="login__link" href="student_forgot_password.php">
